...
public class C03_Date {
    public static void main(String[] args) {
        ...
        System.out.println(tarih.getDayOfYear()); // bugun  yilin 204.u gunu
        System.out.println(tarih.getDayOfWeek()); // bugun haftanin saturday gunu
        System.out.println(tarih.getMonthValue()); // 7.ay
        System.out.println(tarih.isLeapYear()); // artik yil mi degil mi // false
        ...
        System.out.println(tarih.plusDays(100)); // 1000 gun sonra 2022-10-31
        System.out.println(tarih.plusYears(5).plusMonths(3).plusDays(12)); // 5yil 3ay 12gun sonra 2027-11-04
        System.out.println(tarih.minusWeeks(20)); // 20 hafta once 2022-03-05
        System.out.println(tarih.minusDays(100).minusMonths(5)); // 100 gun 5 dkk once 2021-11-14
