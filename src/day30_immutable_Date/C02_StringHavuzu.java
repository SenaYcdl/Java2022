...
public class C02_StringHavuzu {
    public static void main(String[] args) {
        ...
        1-esitligin saginda new keyword u olursa java direk yeni bir
        obje ve referansini olusturur
        2-eger esitligin saginda bir method calisiyor veya + islemi
        yapiliyorsa string immutable oldugundan degisikligi kaydetmek uzere hemen
        bir kopya String ve referansi olusturur ,  sonra degeri hesaplayip
