...
public class C08_equals {
    public static void main(String[] args) {
        ...
        /*
        compareTo methodu iki StringBuilder i bastan baslayaraka harf harf karsilastitirir
       ilk harfler ayni ise ikincilere gecer
       ikinciler ayni ise ucunculere gecer ve ilk farkli olan harfe kadar gider
       farkli olana iki harfin ascii kodlari arasindaki farki verir
